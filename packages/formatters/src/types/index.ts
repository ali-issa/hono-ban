/**
 * Type definitions for Hono Ban error formatters.
 *
 * This module provides type definitions for error formatters, with a focus on the
 * RFC 7807 Problem Details format. It includes interfaces and types for validation
 * parameters, constraint violations, and the complete problem details structure.
 * These types support the creation of standardized error responses that conform to
 * web standards and best practices.
 *
 * @module hono-ban/formatters/types
